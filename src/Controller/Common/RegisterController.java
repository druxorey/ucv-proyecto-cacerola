...
public class RegisterController {
	...
	public boolean validateRegistrationFields(String firstName, String lastName, String email, String userId) {
	...
	public RegisterController(RegisterView registerView) {
		...
		if (registerView != null) {
			...
			this.registerView.returnButton.addActionListener(_ -> returnToLogin());
		}
	}
	...
	private void submitRegistrationRequest() {
		...
		if (!validateRegistrationFields(firstName, lastName, email, userId)) {
		...
		try {
			EmailSender.sendEmail(EMAIL_RECIPIENT, subject, message);
